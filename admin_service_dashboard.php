...
.container{
    border: 3px solid rgba(180, 91, 106, 0.064);
    width: 1300px;
    ...
    background: rgba(15, 14, 15, 0.323);
    box-shadow:5px 5px 40px #714343 ;
    margin-top: 50px;
...
.rightinnerdiv {
    float: right;
    width: 75%;
    box-shadow:0px 6px 40px #1d0101 ;
}

.innerright {
    background-color: #f3bd7e;
    backdrop-filter: blur(1px);
    background: rgba(245, 201, 201, 0.274);
}
...
@media screen and (M-width:600px) {
    .greenbtn,
...
th{
    background-color: rgba(163, 37, 58, 0.54);
    color: rgb(255, 255, 255);
}
td{
    background-color: #824a4a98;
    color: black;
}
td, a{
    color:black;
        ...
        body {
            /* font-family: 'Roboto'; */
            background-image: url('https://static01.nyt.com/images/2020/10/18/multimedia/18sp-ourfuture-libraries/18sp-ourfuture-libraries-superJumbo.gif');
...
elseif($msg=="fail"){
    ...
    ?> -->
        ...
        <div class="innerdiv">
            ...
            padding: 1px;'>Person Name</th><th>person type</th><th>Book name</th><th>Days </th> <th>Approve</th></tr>";
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>
                 Other<input type="radio" name="branch" value="BSC IT"/>BSC IT<div style="margin-left:80px"><input type="radio" name="branch" value="BCA"/>BCA<input type="radio" name="branch" value="MCA"/>MCA</div>
            </div>   
...
<br>
           <label>Days</label> <input type="number" name="days"/>
            ...
            <button type="submit btn1" value="SUBMIT">SUBMIT</button>
            </form>
            </div>
            </div>
...
?>
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[9]</td>";
                $table.="<td>$row[10]</td>";
                $table.="<td><a href='admin_service_dashboard.php?viewid=$row[0]'>
